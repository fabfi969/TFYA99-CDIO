def writetofile(f, epot_list, ekin_list, etot_list, temperature_list, pressure_list, cohesive_energy, bulk_modulus):
    ...
    print("Bulk modulus: ", bulk_modulus, "unit..?", file=f)
    f.close()
