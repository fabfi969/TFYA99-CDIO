...
calculator = LennardJones([18], [0.010323], [3.40], rCut=-1, modified=True)
...
def printenergy(a=atoms):
    ...
    parprint(step, "Energy per atom: Epot = %.3feV Ekin = %.3feV (T=%3.0fK) " "Etot = %.3feV" % (epot_per_atom, ekin_per_atom, ekin_per_atom / (1.5 * units.kB), epot_per_atom + ekin_per_atom))
    step+=100
